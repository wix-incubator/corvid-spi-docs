...
- [Adapter for MySQL databases deployed to Google AppEngine](https://github.com/wix/corvid-external-db-mysql-adapter)
- [Adapter for Google Cloud Firestore with Cloud Run or AppEngine](https://github.com/wix-incubator/firestore-connector-node)
